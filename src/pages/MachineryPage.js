          ...
          <div className="payment-method-container">
            ...
            {paymentMethod === "INSTALLMENT" && (
              <div className="installment-message">
                <p>توجه: به منظور نهایی سازی مراحل ثبت نام خواهشمند است دو فقره چک صیادی به شرح ذیل ثبت و به شرکت یا اتاق اصناف  کشاورزی محل اقامت خود ارائه نمایید:</p>
                <p>
                  چک اول:‌ تاریخ: یک ماه بعد از واریز مبلغ اولیه.    به مبلغ: ۳ ملیون تومان
                </p>
                <p>
                  چک دوم:‌ تاریخ: یک ماه بعد از تاریخ سررسید چک اول.    به مبلغ: ۳ ملیون تومان
                </p>
                <p>
